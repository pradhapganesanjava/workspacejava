package com.pg.algorithm.graph.dijkstra;
...
public class GraphDijkstra {
	...
	void printGraph() {
		...
		PriorityQueue<queueNode> queue = new PriorityQueue<queueNode>(10, comparator);
	...
	void updateQueue(PriorityQueue queue, int node_id, int oldDist, int newDist) {
		...
		// the new possible distance also has to be updated in the priority
		// queue
