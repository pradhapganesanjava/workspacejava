...
public class SinglyLinkedList_Tail {
	...
	public static void main(String... str) {
		...
		SinglyLL<String> strSLL = new SinglyLL<>();
		strSLL.addFirst("A");
		strSLL.addFirst("B");
		strSLL.addFirst("C");
	}
 ...
 */
class SinglyLL<E> implements Cloneable {
	// ---------------- nested Node class ----------------
	/**
	...
	// instance variables of the SinglyLL
	...
	public boolean equals(Object o) {
		...
		if (getClass() != o.getClass())
			return false;
		SinglyLL other = (SinglyLL) o; // use nonparameterized
														// type
		if (size != other.size)
			return false;
	...
	@SuppressWarnings({ "unchecked" })
	public SinglyLL<E> clone() throws CloneNotSupportedException {
		// always use inherited Object.clone() to create the initial copy
		SinglyLL<E> other = (SinglyLL<E>) super.clone(); // safe
																			// cast
